        ...
        if self.load_dir:
            if self.cuda:
                ...
                self.actor_critic.load_state_dict(
                    ...
                    torch.load(self.load_dir + "/actor_critic.pt", map_location=lambda storage, loc: storage),
                )
                self.optimizer.load_state_dict(
                    
                    torch.load(self.load_dir + "/optimizer.pt", map_location=lambda storage, loc: storage),
